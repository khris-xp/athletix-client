    ...
    return (
        <CustomerRoute>
            <Fragment>
                <Layout>
                    <div
                        className='min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 pb-40 pt-16'
                    >
                        <div
                        ...
                        >
                            <div className='w-full pt-1 pb-5'>
                                <div
                                    className='bg-indigo-500 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center'
                                >
