...
import { getEquipmentService, getEquipmentByIdService, editEquipmentService } from "@/services/equipment.services";
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <input type="number" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="0"
                                                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                                                        setEquipment({ ...equipment, price_per_unit: parseFloat(event.target.value) })
                                                    }}
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <input type="number" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="0"
                                                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                                                        setEquipment({ ...equipment, quantity: parseFloat(event.target.value) })
                                                    }}
...
export const getStaticPaths: GetStaticPaths = async () => {
    try {
        ...
        const paths = equipmentItems.map((equipmentItems: { _Equipment__id: string }) => ({
