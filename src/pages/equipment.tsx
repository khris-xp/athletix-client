                ...
                <div className="relative overflow-auto shadow-md sm:rounded-lg mb-20">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        {data.map((equipment: IEquipment) => (
                            <EquipmentTable key={equipment._Equipment__id} name={equipment._Equipment__name} price={equipment._Equipment__price_per_unit} quantity={equipment._Equipment__quantity} />
                        ))}
                    </table>
                </div>
            </Layout>
