            ...
            {!isAuthenticated ? (
              <Fragment>
                <Link href="/login">
                  <button
                    type="button"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-3 text-center mr-3 md:mr-0"
                  >
                    Sign in
                  </button>
                </Link>
              ...
              <Fragment>
                ...
                >
                  <Image
                    ...
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-NBM75ZQZZnw1LjpWznA06oYugMc2aPgGvMm9F_3XoeANFiUtQ5OZ_tq7ykNQCPrHoAE&usqp=CAU"
                    width={1000}
                    height={1000}
                    alt="user-photo"
                    priority
