...
const EquipmentTable = ({ id, name, price, quantity, category }: Props) => {
    ...
    <Fragment>
      <tbody>
        <tr className="bg-white border-b text-center">
          ...
          <td className="px-6 py-4">{price} Bath</td>
          <td className="px-6 py-4">{quantity}</td>
          <td className="px-6 py-4 uppercase">{category}</td>
          <td className="px-6 py-4">
            <div className="space-x-3">
              <Link
                href={`/equipment/edit/${id}`}
